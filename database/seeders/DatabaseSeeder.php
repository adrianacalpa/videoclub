...
class DatabaseSeeder extends Seeder
{
    private $arrayPeliculas = array(
		...
		array(
			...
			'year' => '1974', 
			'director' => 'Francis Ford Coppola', 
			'poster' => 'https://i.pinimg.com/736x/e3/98/52/e39852cdecfa7ceb3f26bf89b11a4dcb.jpg', 
			'rented' => false, 
		...
		array(
			...
			'poster' => 'https://i.pinimg.com/originals/f4/0d/e3/f40de38f7ae4b10e55c29bb1cd63359a.jpg', 
			'rented' => true, 
		...
		array(
			...
			'poster' => 'https://www.alohacriticon.com/wp-content/uploads/elcriticonfotos/elgolpecartel.jpg', 
			'rented' => false, 
		...
		array(
			...
			'poster' => 'https://www.radiomontecarlo.cl/wp-content/uploads/2019/12/s592.jpg', 
			'rented' => true, 
		...
		array(
			...
			'year' => '1998', 
			'director' => 'Tony Kaye', 
			'poster' => 'https://pics.filmaffinity.com/American_History_X-483807206-large.jpg', 
			'rented' => false, 
		...
		array(
			...
			'poster' => 'https://4.bp.blogspot.com/-M4__F2VN3Sw/U_GDOQPPS7I/AAAAAAAAGDs/IPmy3o5752k/s1600/7.jpg', 
			'rented' => true, 
		...
		array(
			...
			'poster' => 'https://elporquedefry.files.wordpress.com/2013/01/clockwork_orange_1.jpg?w=1024&h=1024', 
			'rented' => false, 
		...
		array(
			...
			'year' => '1976', 
			'director' => 'Martin Scorsese', 
			'poster' => 'https://static1.squarespace.com/static/55c89b4fe4b0825f35047658/t/5af3a61b03ce64236e56dbdc/1525917213455/?format=1500w', 
			'rented' => false, 
    ...
    private function seedCatalog(){
        // Borrar los datos de la tabla catalog
	...
	private function seedUsers(){
		...
		// Se agregarn los usuarios de prueba
		DB::table('users')->insert([
			"name"=>"Adriana Calpa",
			"email"=>"adrianacalpab@udenar.edu.co",
			"password"=> bcrypt("prueba123")
		]);
		DB::table('users')->insert([
			"name"=>"Robert Caicedo",
			"email"=>"robert@udenar.edu.co",
    ...
    public function run() {  
		...
		self::seedUsers();
		$this->command->info('¡Tabla usuario iniciada con datos!');
